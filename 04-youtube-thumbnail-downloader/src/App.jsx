    ...
    <div className="min-h-screen relative overflow-hidden bg-neutral-950 text-white">
      ...
      <main className="relative z-10 max-w-5xl mx-auto px-6 py-14">
        <div className="text-center">
          ...
          <h1 className="mt-4 text-4xl sm:text-5xl font-extrabold leading-tight tracking-tight bg-gradient-to-r from-indigo-400 to-sky-400 bg-clip-text text-transparent animate__animated animate__fadeInDown">
          ...
          <section className="mt-10 animate__animated animate__fadeIn">
            <div className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur p-4">
              ...
              <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 py-4">
                {sizes.map((s) => {
                  const thumb = `https://i.ytimg.com/vi/${videoId}/${s.key}.jpg`;
                  return (
                    <div
                      key={s.key}
                      className="group rounded-xl border border-white/10 bg-neutral-900/40 overflow-hidden"
                    >
                      ...
                      <div className="p-3 flex items-center justify-between text-sm">
                        ...
                        <a
                          ...
                          download={`youtube-${videoId}-${s.key}.jpg`}
              ...
              <p className="mt-3 text-xs text-neutral-400 ">
                Tip: If “Max” shows a broken image, the video may not have a
                max‑res thumbnail. Use HQ/SD instead.
              </p>
            </div>
          </section>
        )}
